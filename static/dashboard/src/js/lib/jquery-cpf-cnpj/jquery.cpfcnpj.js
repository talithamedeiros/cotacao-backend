...
(function ($) {
    ...
    function validate_cnpj(val) {
        if(
            val == '111.111.111-11/1111-11' || val == '222.222.222-22/2222-22' || val == '333.333.333-33/3333-33' ||
            val == '444.444.444-44/4444-44' || val == '555.555.555-55/5555-55' || val == '666.666.666-66/6666-66' ||
            val == '777.777.777-77/7777-77' || val == '888.888.888-88/8888-88' || val == '999.999.999-99/9999-99' ){
                return false;
        }
    ...
    function validate_cpf(val) {
        if(
            val == '111.111.111-11' || val == '222.222.222-22' || val == '333.333.333-33' ||
