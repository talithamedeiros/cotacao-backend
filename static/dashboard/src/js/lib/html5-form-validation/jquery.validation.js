...
(function(window, document, $, undefined) {
    ...
    var _messages = {
        'default': '$ contém erro(s).',
        'NOTEMPTY': '$ precisa ser preenchido.',
        'INTEGER': '$ deve ser um inteiro.',
        'NUMERIC': '$ precisa ser um valor numérico.',
        'MIXED': '$ deve conter apenas letras e números (sem caractéres especiais).',
        'NAME': '$ não pode conter caractéres especiais.',
        'NOSPACE': '$ não deve conter espaços.',
        'TRIM': '$ não deve começar, nem terminar com espaços em branco.',
        'DATE': '$ não está no formato valido DD-MM-YYYY.',
        'EMAIL': '$ não é um email válido.',
        'URL': '$ não é válida.',
        'PHONE': '$ não é um número de telefone válido.',
        '<': '$ precisa ter menos de % caractéres.',
        '<=': '$ precisa ter no máximo % caractéres.',
        '>': '$ precisa ter mais que % caractéres.',
        '>=': '$ precisa ter no mínimo % caractéres.',
        '==': '$ deve ser igual a %',
